(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_medicine_MedicineComponent_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/medicine/MedicineComponent.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/medicine/MedicineComponent.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getGenerics: function getGenerics() {
      ...
      axios.get(base_path + "allActiveGeneric").then(function (response) {
    ...
    getManufactures: function getManufactures() {
      ...
      axios.get(base_path + "allActiveManufacture").then(function (response) {
    ...
    getUnits: function getUnits() {
      ...
      axios.get(base_path + "allActiveUnit").then(function (response) {
    ...
    getImage: function getImage() {
      ...
      reader.onload = function (event) {
        _this2.addMedicine.image = event.target.result;
        _this2.editMedicineData.image = event.target.result;
      };

      reader.readAsDataURL(file);
    },
    addNewMedicine: function addNewMedicine() {
      var _this3 = this;

      var _this = this;

      axios.post(base_path + "medicine", _this.addMedicine).then(function (response) {
        console.log(response);

        if (response.data.code == 201) {
          _this3.$toastr.success(response.data.message, "Medicine", {
            timeout: 5000
          });

          var elem = _this3.$refs.addCloseBtn;
          elem.click();
          _this.show = false;
    ...
    ImportMedicine: function ImportMedicine() {
      var _this4 = this;
      ...
      axios.post(base_path + "medicine/import", formData).then(function (response) {
        if (response.status == 200) {
          _this4.$toastr.success(response.data[0], {
            timeOut: 5000
          });
          ...
          _this4.$toastr.warning("Something Went Wrong", "Sorry!", {
            timeOut: 5000
          });
        }
      })["catch"](function (error) {
        if (error.response.status === 422) {
          _this4.$toastr.error("File not valid", "Sorry!", {
            timeOut: 5000
          });
        } else {
          _this.$toastr.warning("Application error", "Sorry", {
    ...
    closeExportModal: function closeExportModal() {
      ...
      var elem = this.$refs.exportCloseBtn;
      elem.click();
    },
    getMedicine: function getMedicine() {
      ...
      var main_url = base_path + "medicine?q=" + _this.search + "&page=" + page + "&row=" + _this.custom_row;
    ...
    editMedicine: function editMedicine(id) {
      var _this = this;

      axios.get(base_path + "medicine/" + id + "/edit").then(function (response) {
        ...
        _this.editMedicineData.conversion_factor = response.data.conversion_factor;
        _this.editMedicineData.generic_id = response.data.generic_id;
        _this.editMedicineData.manufacturer_id = response.data.manufacturer_id;
        _this.editMedicineData.price = response.data.prices[0].price;
        _this.editMedicineData.primary_unit = response.data.prices[0].unit_id ? response.data.prices[0].unit_id : 2;
        _this.editMedicineData.secondary_unit = response.data.prices[1] ? response.data.prices[1].unit_id : 3;
        _this.editMedicineData.third_unit = response.data.prices[2] ? response.data.prices[2].unit_id : 4;
    ...
    filterNeg: function filterNeg(event) {
      if (!(event.keyCode > 95 && event.keyCode < 106 || event.keyCode > 47 && event.keyCode < 58 || event.keyCode == 8)) {
        return event.preventDefault();
      }
    },
    updateMedicine: function updateMedicine(id) {
      var _this5 = this;

      var _this = this;

      axios.put(base_path + "medicine/" + id, _this.editMedicineData).then(function (response) {
        if (response.data.code == 201) {
          ...
          var elem = _this5.$refs.updateCloseBtn;
          elem.click();
        }
      })["catch"](function (error) {
        console.log(error);
    ...
    duplicateMedicine: function duplicateMedicine() {
      var _this = this;
    ...
    changeStatus: function changeStatus(id) {
      ...
      axios.get(base_path + "medicine/status/" + id).then(function (response) {
        _this.getMedicine(_this.current_page);
    ...
    deleteMedicine: function deleteMedicine(id) {
      ...
      this.$swal({
        ...
        if (result.value) {
          axios["delete"](base_path + "medicine/" + id).then(function (response) {
            _this.getMedicine(_this.current_page);
    ...
    viewStock: function viewStock(id) {
      var self = this;
      axios.get(base_path + "medicine/" + id).then(function (response) {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/medicine/MedicineComponent.vue?vue&type=style&index=0&id=5e165ab9&scoped=true&lang=css&":
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/medicine/MedicineComponent.vue?vue&type=style&index=0&id=5e165ab9&scoped=true&lang=css& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\nlabel[data-v-5e165ab9] {\n\tmargin-right: 15px;\n}\n.form-control[data-v-5e165ab9] {\n\tborder: 1px solid #c8c1c1;\n}\ntable tr[data-v-5e165ab9] {\n\ttext-align: center;\n}\ntable tr th[data-v-5e165ab9] {\n\tcolor: #000000d4;\n\tfont-weight: 700;\n\ttext-align: center;\n}\n.search-box[data-v-5e165ab9] {\n\theight: 30px;\n\tmargin: 20px 0px 8px;\n}\n[data-v-5e165ab9]::-moz-placeholder {\n\tcolor: #4e5157;\n\topacity: 1;\n}\n[data-v-5e165ab9]:-ms-input-placeholder {\n\tcolor: #4e5157;\n\topacity: 1;\n}\n[data-v-5e165ab9]::placeholder {\n\tcolor: #4e5157;\n\topacity: 1;\n}\n[data-v-5e165ab9]:-ms-input-placeholder {\n\tcolor: #4e5157;\n}\n[data-v-5e165ab9]::-ms-input-placeholder {\n\tcolor: #4e5157;\n}\n.dropbtn[data-v-5e165ab9] {\n\tbackground-color: #4caf50;\n\tcolor: white;\n\tborder: none;\n\tcursor: pointer;\n}\n\n/* The container <div> - needed to position the dropdown content */\n.dropdown[data-v-5e165ab9] {\n\tposition: relative;\n\tdisplay: inline-block;\n}\n\n/* Dropdown Content (Hidden by Default) */\n.dropdown-content[data-v-5e165ab9] {\n\tdisplay: none;\n\tposition: absolute;\n\tbackground-color: #f9f9f9;\n\tmin-width: 100px;\n\tbox-shadow: 0px 8px 16px 0px rgba(0, 0, 0, 0.2);\n\tz-index: 1;\n}\n\n/* Links inside the dropdown */\n.dropdown-content a[data-v-5e165ab9] {\n\tcolor: black;\n\tpadding: 12px 16px;\n\ttext-decoration: none;\n\tdisplay: block;\n\tcursor: pointer;\n}\n\n/* Change color of dropdown links on hover */\n.dropdown-content a[data-v-5e165ab9]:hover {\n\tbackground-color: #f1f1f1;\n}\n\n/* Show the dropdown menu on hover */\n.dropdown:hover .dropdown-content[data-v-5e165ab9] {\n\tdisplay: block;\n}\n\n/* Change the background color of the dropdown button when the dropdown content is shown */\n.dropdown:hover .dropbtn[data-v-5e165ab9] {\n\tbackground-color: #004a88;\n}\n.modal-mask[data-v-5e165ab9] {\n\tposition: fixed;\n\tz-index: 9998;\n\ttop: 0;\n\tleft: 0;\n\twidth: 100%;\n\theight: 100%;\n\tbackground-color: rgba(0, 0, 0, 0.5);\n\tdisplay: table;\n\ttransition: opacity 0.3s ease;\n}\n.modal-wrapper[data-v-5e165ab9] {\n\tdisplay: table-cell;\n\tvertical-align: middle;\n}\n.modal-container[data-v-5e165ab9] {\n\twidth: 60%;\n\tmargin: 0px auto;\n\tpadding: 0.5%;\n\tbackground-color: #004a88;\n\tborder-radius: 2px;\n\tbox-shadow: 0 2px 8px rgba(0, 0, 0, 0.33);\n\ttransition: all 0.3s ease;\n\tfont-family: Helvetica, Arial, sans-serif;\n\toverflow: auto;\n\tmax-height: 90%;\n\theight: 90%;\n}\n.modal-header h3[data-v-5e165ab9] {\n\tmargin-top: 0;\n\tcolor: #42b983;\n}\n.modal-body[data-v-5e165ab9] {\n\tmargin: 20px 0;\n}\n.modal-default-button[data-v-5e165ab9] {\n\tfloat: right;\n}\n\n/*\n * the following styles are auto-applied to elements with\n * v-transition=\"modal\" when their visiblity is toggled\n * by Vue.js.\n *\n * You can easily play with the modal transition by editing\n * these styles.\n */\n.modal-enter[data-v-5e165ab9],\n.modal-leave[data-v-5e165ab9] {\n\topacity: 0;\n}\n.modal-enter .modal-container[data-v-5e165ab9],\n.modal-leave .modal-container[data-v-5e165ab9] {\n\ttransform: scale(1.1);\n}\n", ""]);
// Exports
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_MedicineComponent_vue_vue_type_style_index_0_id_5e165ab9_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./MedicineComponent.vue?vue&type=style&index=0&id=5e165ab9&scoped=true&lang=css& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/medicine/MedicineComponent.vue?vue&type=style&index=0&id=5e165ab9&scoped=true&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_MedicineComponent_vue_vue_type_style_index_0_id_5e165ab9_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./resources/js/components/medicine/MedicineComponent.vue":
/*!****************************************************************!*\
  !*** ./resources/js/components/medicine/MedicineComponent.vue ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _MedicineComponent_vue_vue_type_template_id_5e165ab9_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MedicineComponent.vue?vue&type=template&id=5e165ab9&scoped=true& */ "./resources/js/components/medicine/MedicineComponent.vue?vue&type=template&id=5e165ab9&scoped=true&");
/* harmony import */ var _MedicineComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MedicineComponent.vue?vue&type=script&lang=js& */ "./resources/js/components/medicine/MedicineComponent.vue?vue&type=script&lang=js&");
/* harmony import */ var _MedicineComponent_vue_vue_type_style_index_0_id_5e165ab9_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MedicineComponent.vue?vue&type=style&index=0&id=5e165ab9&scoped=true&lang=css& */ "./resources/js/components/medicine/MedicineComponent.vue?vue&type=style&index=0&id=5e165ab9&scoped=true&lang=css&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _MedicineComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _MedicineComponent_vue_vue_type_template_id_5e165ab9_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _MedicineComponent_vue_vue_type_template_id_5e165ab9_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "5e165ab9",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/medicine/MedicineComponent.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/medicine/MedicineComponent.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************!*\
  !*** ./resources/js/components/medicine/MedicineComponent.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_MedicineComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./MedicineComponent.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/medicine/MedicineComponent.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_MedicineComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/medicine/MedicineComponent.vue?vue&type=style&index=0&id=5e165ab9&scoped=true&lang=css&":
/*!*************************************************************************************************************************!*\
  !*** ./resources/js/components/medicine/MedicineComponent.vue?vue&type=style&index=0&id=5e165ab9&scoped=true&lang=css& ***!
  \*************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_MedicineComponent_vue_vue_type_style_index_0_id_5e165ab9_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/style-loader/dist/cjs.js!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./MedicineComponent.vue?vue&type=style&index=0&id=5e165ab9&scoped=true&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/medicine/MedicineComponent.vue?vue&type=style&index=0&id=5e165ab9&scoped=true&lang=css&");


/***/ }),

/***/ "./resources/js/components/medicine/MedicineComponent.vue?vue&type=template&id=5e165ab9&scoped=true&":
/*!***********************************************************************************************************!*\
  !*** ./resources/js/components/medicine/MedicineComponent.vue?vue&type=template&id=5e165ab9&scoped=true& ***!
  \***********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_MedicineComponent_vue_vue_type_template_id_5e165ab9_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_MedicineComponent_vue_vue_type_template_id_5e165ab9_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_MedicineComponent_vue_vue_type_template_id_5e165ab9_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./MedicineComponent.vue?vue&type=template&id=5e165ab9&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/medicine/MedicineComponent.vue?vue&type=template&id=5e165ab9&scoped=true&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/medicine/MedicineComponent.vue?vue&type=template&id=5e165ab9&scoped=true&":
/*!**************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/medicine/MedicineComponent.vue?vue&type=template&id=5e165ab9&scoped=true& ***!
  \**************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function () {
  ...
  return _c("div", [
    _c("h3", [_vm._v("Medicine List")]),
    _vm._v(" "),
    _c("br"),
    _vm._v(" "),
    _c("div", { staticClass: "panel panel-primary" }, [
      _c("div", { staticClass: "panel-heading" }, [
        _c("div", { staticClass: "panel-title" }, [_vm._v("Medicine List")]),
        _vm._v(" "),
        _c(
          "div",
          {
          ...
          [
            _vm.permissions.includes("Print_Medicine")
              ? _c(
                  "button",
                  {
              ...
              : _vm._e(),
            _vm._v(" "),
            _vm.permissions.includes("Add_Medicine")
              ? _c(
                  "button",
                  {
            ...
            _c("div", { staticClass: "row" }, [
              ...
              _c("div", { staticClass: "col-md-5" }, [
                _c("input", {
                  ...
                  staticClass: "form-control search-box col-sm-11",
                ...
                _c(
                  "button",
                  {
                    staticClass: "btn btn-info btn-sm col-sm-1",
      ...
      _c("div", { staticClass: "table-responsive" }, [
        _c("table", { staticClass: "table table-bordered" }, [
          ...
          _c(
            "tbody",
            _vm._l(_vm.medicineData.data, function (data, index) {
              return _c("tr", { key: index }, [
                ...
                _c("td", [
                  _vm._v(
                    "\n\t\t\t\t\t\t\t\t" +
                      _vm._s(data.category && data.category.category_name) +
                      "\n\t\t\t\t\t\t\t\t"
                  ),
                  _c(
                    "b",
                ...
                _c("td", [
                  _vm._v(
                    _vm._s(
                      data.manufacturer
                        ? data.manufacturer.manufacture_name
                        : "Not Set"
                    )
                  ),
                ]),
                    ...
                    attrs: {
                      src: data.image
                        ? data.image.charAt(0) == "/"
                          ? data.image
                          : "/" + data.image
                        : "/frontend_assets/assets/img/item.png",
                      width: "40",
                    },
                  }),
                ]),
                _vm._v(" "),
                _c("td", { staticClass: "text-center" }, [
                  _vm.permissions.includes("Status_Medicine")
                    ? _c(
                        "span",
                        {
                          staticClass: "badge",
                        ...
                        [
                          _vm._v(
                            _vm._s(data.status == 1 ? "Active" : "Inactive")
                          ),
                        ]
                      )
                    : _c(
                ...
                _vm._v(" "),
                _c("td", { staticClass: "text-center" }, [
                  _vm.permissions.includes("View_Medicine")
                    ? _c(
                        "button",
                        {
                    ...
                    : _vm._e(),
                  _vm._v(" "),
                  _vm.permissions.includes("Edit_Medicine")
                    ? _c(
                        "button",
                        {
                          ...
                          on: {
                            click: function ($event) {
                              return _vm.editMedicine(data.id)
                            },
                          },
                        },
                    ...
                    : _vm._e(),
                  _vm._v(" "),
                  _vm.permissions.includes("Delete_Medicine")
                    ? _c(
                        "button",
                        {
                          ...
                          on: {
                            click: function ($event) {
                              return _vm.deleteMedicine(data.id)
                            },
                          },
                        },
          ...
          _c(
            ...
            _vm._l(_vm.medicineData.data, function (data, index) {
              return _c("tr", { key: index }, [
                ...
                _c("td", [
                  _vm._v(
                    _vm._s(data.generic ? data.generic.generic_name : "Not Set")
                  ),
                ]),
                _vm._v(" "),
                _c("td", [
      ...
      [
        _c(
          "pagination",
          {
            ...
            attrs: { data: _vm.medicineData, limit: 3 },
            on: { "pagination-change-page": _vm.getMedicine },
          },
          [
          ...
          _c("div", { staticClass: "modal-content" }, [
            ...
            _c("div", { staticClass: "modal-body" }, [
              _c("div", { staticClass: "col-md-12" }, [
                _c("table", { staticClass: "table table-borderd" }, [
                  ...
                  _c(
                    "tbody",
                    _vm._l(_vm.ViewStock, function (stock, key) {
                      return _c("tr", [
                        _c("td", [_vm._v(_vm._s(++key))]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(stock.batch))]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(stock.exp_date))]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(stock.stock))]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(stock.sale))]),
                      ])
                    }),
                    0
                  ),
            ...
            _c("div", { staticClass: "modal-footer" }, [
              _c(
                "a",
                {
                  staticClass: "btn btn-success btn-icon icon-left",
                  attrs: { href: "/medicine/export/" + _vm.exportType },
                  on: {
                    click: function ($event) {
                      return _vm.closeExportModal()
                    },
                  },
                },
                [
    ...
    _c(
      ...
      {
        staticClass: "modal fade in",
        attrs: { "aria-hidden": "true", id: "importModal", tabindex: "-1" },
      },
      [
        _c("div", { staticClass: "modal-dialog" }, [
          _c("div", { staticClass: "modal-content" }, [
              ...
              [
                _c("div", { staticClass: "modal-body" }, [
                  _c(
                    ...
                    [
                      _c("strong", [
                        _vm._v("*Data must not contain ID column."),
                      ]),
                      _vm._v(" "),
                      _c("br"),
                      _vm._v(" "),
                      _c("label", { attrs: { for: "import" } }, [
                        ...
                        _c("span", { staticClass: "btn btn-info btn-file" }, [
                      ...
                      _c(
                        "a",
                        {
                          staticClass: "close fileinput-exists",
                          staticStyle: { float: "none" },
                          attrs: { "data-dismiss": "fileinput", href: "#" },
                        },
                        [_vm._v("×")]
                      ),
                    ]
    ...
    _c(
      ...
      {
        staticClass: "modal fade in",
        attrs: { "aria-hidden": "true", id: "exportModal", tabindex: "-1" },
      },
      [
        _c("div", { staticClass: "modal-dialog" }, [
          _c("div", { staticClass: "modal-content" }, [
    ...
    _vm._v(" "),
    _c("div", { staticClass: "modal fade in", attrs: { id: "addModal" } }, [
            ...
            [
              _c("div", { staticClass: "modal-body" }, [
                _c("div", { staticClass: "row" }, [
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.addMedicine.name,
                            expression: "addMedicine.name",
                          },
                        ],
                        staticClass: "form-control",
                        attrs: { name: "", type: "text" },
                        domProps: { value: _vm.addMedicine.name },
                        on: {
                          input: function ($event) {
                            if ($event.target.composing) {
                              return
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.addMedicine.dosage,
                            expression: "addMedicine.dosage",
                          },
                        ],
                        staticClass: "form-control",
                        attrs: { name: "", type: "text" },
                        domProps: { value: _vm.addMedicine.dosage },
                        on: {
                          input: function ($event) {
                            if ($event.target.composing) {
                              return
                  ...
                  _c("div", { staticClass: "col-md-4" }, [
                    _c("div", { staticClass: "form-group" }, [
                      _c("label", [_vm._v("Alert Quantity")]),
                      _vm._v(" "),
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.addMedicine.alert_quantity,
                            expression: "addMedicine.alert_quantity",
                          },
                        ],
                        staticClass: "form-control",
                        attrs: { name: "", type: "number" },
                        domProps: { value: _vm.addMedicine.alert_quantity },
                        on: {
                          input: function ($event) {
                            if ($event.target.composing) {
                              return
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c("model-select", {
                          ...
                          model: {
                            value: _vm.addMedicine.category_id,
                            callback: function ($$v) {
                              _vm.$set(_vm.addMedicine, "category_id", $$v)
                            },
                            expression: "addMedicine.category_id",
                          },
                        }),
                      ],
                      1
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c("model-select", {
                          ...
                          model: {
                            value: _vm.addMedicine.manufacturer_id,
                            callback: function ($$v) {
                              _vm.$set(_vm.addMedicine, "manufacturer_id", $$v)
                            },
                            expression: "addMedicine.manufacturer_id",
                          },
                        }),
                      ],
                      1
                  ...
                  _c("div", { staticClass: "col-md-4" }, [
                    _c(
                      ...
                      { staticClass: "form-group" },
                      [
                        _c("label", [_vm._v("Generic")]),
                        _vm._v(" "),
                        _c("model-select", {
                          attrs: {
                            options: _vm.generics,
                            placeholder: "Select Generic",
                          },
                          model: {
                            value: _vm.addMedicine.generic_id,
                            callback: function ($$v) {
                              _vm.$set(_vm.addMedicine, "generic_id", $$v)
                            },
                            expression: "addMedicine.generic_id",
                          },
                        }),
                      ],
                      1
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c("model-select", {
                          ...
                          model: {
                            value: _vm.addMedicine.primary_unit,
                            callback: function ($$v) {
                              _vm.$set(_vm.addMedicine, "primary_unit", $$v)
                            },
                            expression: "addMedicine.primary_unit",
                          },
                        }),
                      ],
                      1
                  ...
                  _c("div", { staticClass: "col-md-4" }, [
                    _c(
                      ...
                      { staticClass: "form-group" },
                      [
                        _c("label", [_vm._v("Secondary Unit")]),
                        _vm._v(" "),
                        _c("model-select", {
                          attrs: {
                            options: _vm.units,
                          ...
                          model: {
                            value: _vm.addMedicine.secondary_unit,
                            callback: function ($$v) {
                              _vm.$set(_vm.addMedicine, "secondary_unit", $$v)
                            },
                            expression: "addMedicine.secondary_unit",
                          },
                        }),
                      ],
                      1
                  ...
                  _c("div", { staticClass: "col-md-4" }, [
                    _c("div", { staticClass: "form-group" }, [
                      _c("label", [_vm._v("Conversion Factor")]),
                      _vm._v(" "),
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.addMedicine.conversion_factor,
                            expression: "addMedicine.conversion_factor",
                          },
                        ],
                        staticClass: "form-control",
                        attrs: { min: "1", type: "number" },
                        domProps: { value: _vm.addMedicine.conversion_factor },
                        on: {
                          keypress: function ($event) {
                            return _vm.filterNeg($event)
                          },
                          input: function ($event) {
                            if ($event.target.composing) {
                              return
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c("model-select", {
                          ...
                          model: {
                            value: _vm.addMedicine.third_unit,
                            callback: function ($$v) {
                              _vm.$set(_vm.addMedicine, "third_unit", $$v)
                            },
                            expression: "addMedicine.third_unit",
                          },
                        }),
                      ],
                      1
                  ...
                  _c("div", { staticClass: "col-md-4" }, [
                    _c("div", { staticClass: "form-group" }, [
                      _c("label", [_vm._v("Conversion Factor Third")]),
                      _vm._v(" "),
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.addMedicine.conversion_factor_third,
                            expression: "addMedicine.conversion_factor_third",
                          },
                        ],
                        staticClass: "form-control",
                        attrs: { min: "1", type: "number" },
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.addMedicine.price,
                            expression: "addMedicine.price",
                          },
                        ],
                        staticClass: "form-control",
                        attrs: { step: "0.01", type: "number" },
                        domProps: { value: _vm.addMedicine.price },
                        on: {
                          input: function ($event) {
                            if ($event.target.composing) {
                              return
                      ...
                      _c("center", [
                        _c(
                          ...
                          [
                            _c("img", {
                              attrs: {
                                src: _vm.addMedicine.image
                                  ? _vm.addMedicine.image
                                  : "/backend_assets/assets/images/sample_img.jpg",
                                height: "100",
                                id: "previmage",
                                width: "100",
                              },
        ...
        _c("div", { staticClass: "modal-content" }, [
          _c("div", { staticClass: "modal-header" }, [
            _c("h5", { staticClass: "modal-title" }, [
              _vm._v("Edit " + _vm._s(_vm.editMedicineData.name) + " Medicine"),
            ]),
            _vm._v(" "),
            _vm._m(8),
          ]),
          ...
          _c(
            "form",
            {
              ...
              on: {
                submit: function ($event) {
                  $event.preventDefault()
                  return _vm.updateMedicine(_vm.editMedicineData.id)
                },
              },
            },
            [
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.editMedicineData.name,
                            expression: "editMedicineData.name",
                          },
                        ],
                        staticClass: "form-control",
                        attrs: { name: "", type: "text" },
                        domProps: { value: _vm.editMedicineData.name },
                        on: {
                          input: function ($event) {
                            if ($event.target.composing) {
                              return
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.editMedicineData.dosage,
                            expression: "editMedicineData.dosage",
                          },
                        ],
                        staticClass: "form-control",
                        attrs: { name: "", type: "text" },
                        domProps: { value: _vm.editMedicineData.dosage },
                        on: {
                          input: function ($event) {
                            if ($event.target.composing) {
                              return
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.editMedicineData.alert_quantity,
                            expression: "editMedicineData.alert_quantity",
                          },
                        ],
                        staticClass: "form-control",
                        attrs: { name: "", type: "number" },
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c("model-select", {
                          ...
                          model: {
                            value: _vm.editMedicineData.category_id,
                            callback: function ($$v) {
                              _vm.$set(_vm.editMedicineData, "category_id", $$v)
                            },
                            expression: "editMedicineData.category_id",
                          },
                        }),
                      ],
                      1
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c("model-select", {
                          ...
                          model: {
                            value: _vm.editMedicineData.manufacturer_id,
                            callback: function ($$v) {
                              _vm.$set(
                                _vm.editMedicineData,
                                "manufacturer_id",
                            ...
                            expression: "editMedicineData.manufacturer_id",
                          },
                        }),
                      ],
                      1
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c("model-select", {
                          ...
                          model: {
                            value: _vm.editMedicineData.generic_id,
                            callback: function ($$v) {
                              _vm.$set(_vm.editMedicineData, "generic_id", $$v)
                            },
                            expression: "editMedicineData.generic_id",
                          },
                        }),
                      ],
                      1
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c("model-select", {
                          ...
                          model: {
                            value: _vm.editMedicineData.primary_unit,
                            callback: function ($$v) {
                              _vm.$set(
                                _vm.editMedicineData,
                                "primary_unit",
                            ...
                            expression: "editMedicineData.primary_unit",
                          },
                        }),
                      ],
                      1
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c("model-select", {
                          ...
                          model: {
                            value: _vm.editMedicineData.secondary_unit,
                            callback: function ($$v) {
                              _vm.$set(
                                _vm.editMedicineData,
                                "secondary_unit",
                            ...
                            expression: "editMedicineData.secondary_unit",
                          },
                        }),
                      ],
                      1
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.editMedicineData.conversion_factor,
                            expression: "editMedicineData.conversion_factor",
                          },
                        ],
                        staticClass: "form-control",
                        attrs: { min: "1", type: "number" },
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c("model-select", {
                          ...
                          model: {
                            value: _vm.editMedicineData.third_unit,
                            callback: function ($$v) {
                              _vm.$set(_vm.editMedicineData, "third_unit", $$v)
                            },
                            expression: "editMedicineData.third_unit",
                          },
                        }),
                      ],
                      1
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.editMedicineData.conversion_factor_third,
                            expression:
                              "editMedicineData.conversion_factor_third",
                          },
                        ],
                        staticClass: "form-control",
                        attrs: { min: "1", type: "number" },
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.editMedicineData.price,
                            expression: "editMedicineData.price",
                          },
                        ],
                        staticClass: "form-control",
                        attrs: { step: "0.01", type: "number" },
                        domProps: { value: _vm.editMedicineData.price },
                        on: {
                          input: function ($event) {
                            if ($event.target.composing) {
                              return
                      ...
                      _c("center", [
                        _c(
                          ...
                          [
                            _c("img", {
                              attrs: {
                                src: _vm.editMedicineData.image
                                  ? _vm.editMedicineData.image
                                  : "/backend_assets/assets/images/sample_img.jpg",
                                height: "100",
                                id: "previmage",
                                width: "100",
              ...
              _vm._v(" "),
              _c("div", { staticClass: "modal-footer" }, [
                _vm.permissions.includes("Duplicate_Medicine")
                  ? _c(
                      "button",
                      {
                                ...
                                directives: [
                                  {
                                    ...
                                    value: _vm.editMedicineData.alert_quantity,
                                    expression:
                                      "editMedicineData.alert_quantity",
                                  },
                                ],
                                staticClass: "form-control",
                                attrs: { name: "", type: "number" },
                              ...
                              [
                                ...
                                _c("model-select", {
                                  ...
                                  model: {
                                    ...
                                    expression:
                                      "editMedicineData.manufacturer_id",
                                  },
                                }),
                              ],
                              1
                              ...
                              [
                                ...
                                _c("model-select", {
                                  ...
                                  model: {
                                    ...
                                    expression:
                                      "editMedicineData.secondary_unit",
                                  },
                                }),
                              ],
                              1
                                ...
                                directives: [
                                  {
                                    ...
                                    rawName: "v-model",
                                    value:
                                      _vm.editMedicineData.conversion_factor,
                                    expression:
                                      "editMedicineData.conversion_factor",
                                  },
                                ],
                                staticClass: "form-control",
                                attrs: { type: "number" },
...
var staticRenderFns = [
  ...
  function () {
    ...
    return _c("thead", [
      _c("tr", [
        ...
        _c("th", { staticClass: "text-center" }, [_vm._v("Product name")]),
        _vm._v(" "),
        _c("th", { staticClass: "text-center" }, [_vm._v("Generic")]),
        _vm._v(" "),
        _c("th", { staticClass: "text-center" }, [_vm._v("Manufacturer")]),
        _vm._v(" "),
        _c("th", { staticClass: "text-center" }, [_vm._v("Price")]),
  ...
  function () {
    ...
    return _c("div", { staticClass: "modal-header" }, [
      _c(
        ...
        [_c("b", [_vm._v("Medicine Stock View")])]
      ),
      _vm._v(" "),
      _c(
        "button",
  ...
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("h3", [_c("b", [_vm._v("Create New Medicine")])])
  },
  function () {
    var _vm = this
    var _h = _vm.$createElement
