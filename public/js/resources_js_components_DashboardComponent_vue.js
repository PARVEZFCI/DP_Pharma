...
/* harmony export */ });
/* harmony import */ var _SaleStatePie_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SaleStatePie.js */ "./resources/js/components/SaleStatePie.js");
/* harmony import */ var _ManufacturerStateBar_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ManufacturerStateBar.js */ "./resources/js/components/ManufacturerStateBar.js");
/* harmony import */ var _IncomeStateDoughnut_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./IncomeStateDoughnut.js */ "./resources/js/components/IncomeStateDoughnut.js");
/* harmony import */ var _ExpenseStateLine__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ExpenseStateLine */ "./resources/js/components/ExpenseStateLine.js");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    SaleStatePie: _SaleStatePie_js__WEBPACK_IMPORTED_MODULE_0__["default"],
    ManufacturerStateBar: _ManufacturerStateBar_js__WEBPACK_IMPORTED_MODULE_1__["default"],
    IncomeStateDoughnut: _IncomeStateDoughnut_js__WEBPACK_IMPORTED_MODULE_2__["default"],
    ExpenseStateLine: _ExpenseStateLine__WEBPACK_IMPORTED_MODULE_3__["default"]
  },
  data: function data() {
    return {
      totalExpense: 0,
  ...
  methods: {
    getCounter: function getCounter() {
      var self = this;
      axios.get(base_path + "dashboard/counter").then(function (response) {
    ...
    getSaleState: function getSaleState() {
      var self = this;
      axios.get(base_path + "dashboard/sale_state").then(function (response) {
    ...
    getManufacturerState: function getManufacturerState() {
      var self = this;
      axios.get(base_path + "dashboard/manufacturer_state").then(function (response) {
    ...
    getIncomeState: function getIncomeState() {
      var self = this;
      axios.get(base_path + "dashboard/income_state").then(function (response) {
    ...
    getExpenseState: function getExpenseState() {
      var self = this;
      axios.get(base_path + "dashboard/expense_state").then(function (response) {
...
/***/ "./resources/js/components/ExpenseStateLine.js":
/*!*****************************************************!*\
  !*** ./resources/js/components/ExpenseStateLine.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/components/IncomeStateDoughnut.js":
/*!********************************************************!*\
  !*** ./resources/js/components/IncomeStateDoughnut.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/components/ManufacturerStateBar.js":
/*!*********************************************************!*\
  !*** ./resources/js/components/ManufacturerStateBar.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/components/SaleStatePie.js":
/*!*************************************************!*\
  !*** ./resources/js/components/SaleStatePie.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/DashboardComponent.vue?vue&type=style&index=0&lang=css&":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/DashboardComponent.vue?vue&type=style&index=0&lang=css& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _DashboardComponent_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DashboardComponent.vue?vue&type=style&index=0&lang=css& */ "./resources/js/components/DashboardComponent.vue?vue&type=style&index=0&lang=css&");
  ...
  return _c("div", [
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-sm-3 col-xs-6" }, [
        _c(
          "div",
          { staticClass: "tile-stats tile-pink" },
          [
            _vm._m(0),
            _vm._v(" "),
            _c("countTo", {
              staticClass: "num",
              attrs: { duration: 5000, endVal: _vm.totalExpense, startVal: 0 },
            }),
            _vm._v(" "),
            _c("h3", [_vm._v("Today's Expense")]),
            _vm._v(" "),
            _c("p", [_vm._v("Today's total expense.")]),
          ],
          1
        ),
      ]),
      ...
      _c("div", { staticClass: "col-sm-3 col-xs-6" }, [
        _c(
          "div",
          { staticClass: "tile-stats tile-black" },
          [
            _vm._m(1),
            _vm._v(" "),
            _c("countTo", {
              staticClass: "num",
              attrs: { duration: 5000, endVal: _vm.totalIncome, startVal: 0 },
            }),
            _vm._v(" "),
            _c("h3", [_vm._v("Today's Income")]),
            _vm._v(" "),
            _c("p", [_vm._v("Today's total income.")]),
          ],
          1
        ),
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "clear visible-xs" }),
      _vm._v(" "),
      _c("div", { staticClass: "col-sm-3 col-xs-6" }, [
        _c(
          "div",
          { staticClass: "tile-stats tile-aqua" },
          [
            _vm._m(2),
            _vm._v(" "),
            _c("countTo", {
              staticClass: "num",
              attrs: { duration: 5000, endVal: _vm.todaySale, startVal: 0 },
            }),
            _vm._v(" "),
            _c("h3", [_vm._v("Today's Sell")]),
            _vm._v(" "),
            _c("p", [_vm._v("Total number of sold medicine today.")]),
          ],
          1
        ),
      ]),
      ...
      _c("div", { staticClass: "col-sm-3 col-xs-6" }, [
        _c(
          "div",
          { staticClass: "tile-stats tile-blue" },
          [
            _vm._m(3),
            _vm._v(" "),
            _c("countTo", {
              staticClass: "num",
              attrs: { duration: 5000, endVal: _vm.todayStock, startVal: 0 },
            }),
            _vm._v(" "),
            _c("h3", [_vm._v("Today's Stock")]),
            _vm._v(" "),
            _c("p", [_vm._v("Total number of stock medicine today.")]),
          ],
          1
        ),
      ]),
    ...
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-sm-7" }, [
        _c(
          "div",
          { staticClass: "panel panel-primary", attrs: { id: "charts_env" } },
          [
            _vm._m(4),
            _vm._v(" "),
            _c(
              ...
              [
                _c("IncomeStateDoughnut", {
                  attrs: { chartData: _vm.IncomeStatsCollection, height: 180 },
                }),
              ],
              1
            ),
      ...
      _c("div", { staticClass: "col-sm-5" }, [
        _c("div", { staticClass: "panel panel-primary" }, [
          ...
          _c(
            ...
            [
              _c("SaleStatePie", {
                attrs: { chartData: _vm.SaleStatsCollection, height: 260 },
              }),
            ],
            1
          ),
      ...
      _c("div", { staticClass: "col-sm-5" }, [
        _c("div", { staticClass: "panel panel-primary" }, [
          ...
          _c(
            ...
            [
              _c("ExpenseStateLine", {
                attrs: { chartData: _vm.ExpenseStatsCollection, height: 220 },
              }),
            ],
            1
          ),
        ...
        _c(
          ...
          [
            ...
            _c(
              ...
              { staticClass: "panel-body" },
              [
                _c("ManufacturerStateBar", {
                  attrs: {
                    chartData: _vm.ManufacturerStatsCollection,
                    height: 150,
                  },
                }),
              ],
...
var staticRenderFns = [
  ...
  function () {
    ...
    return _c("div", { staticClass: "panel-heading" }, [
      _c("div", { staticClass: "panel-title" }, [_vm._v("Income Stats")]),
    ])
  },
  function () {
    var _vm = this
    ...
    return _c("div", { staticClass: "panel-heading" }, [
      _c("div", { staticClass: "panel-title" }, [
        _c("div", { staticClass: "panel-title" }, [_vm._v("Sale Stats")]),
      ]),
    ])
  },
  function () {
    ...
    return _c("div", { staticClass: "panel-heading" }, [
      _c("div", { staticClass: "panel-title" }, [
        _c("div", { staticClass: "panel-title" }, [_vm._v("Stock Overview")]),
      ]),
    ])
  },
  function () {
    ...
    return _c("div", { staticClass: "panel-heading" }, [
      _c("div", { staticClass: "panel-title" }, [
        _vm._v("Manufacturer Overview(Last 30Day)"),
      ]),
    ])
  },
]
