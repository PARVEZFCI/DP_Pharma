			...
			<div class="panel-heading">
				<div class="pull-left col-sm-1">
					<div class="form-group">
						...
						<select @change="getStockInfo()" class="form-control" style="position: absolute; top: 6px; left: 59px;" v-model="custom_row">
				...
				<div class="col-md-3" v-show="showCustom">
					<input @change="getStockInfo()" class="form-control search-box" id="from" type="date" v-model="from" />
				</div>
				<div class="col-md-3" v-show="showCustom">
					<input @change="getStockInfo()" class="form-control search-box" id="to" type="date" v-model="to" />
				</div>
			</div>
